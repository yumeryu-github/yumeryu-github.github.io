...
#### <span class="reviewpartition">アクセスして最初に開くのはこういうページです。</span>
...
#### <span class="reviewpartition">検索してみます。</span>
...
#### <span class="reviewpartition">商品を選びます。</span>
...
#### <span class="reviewpartition">カートに入れます。</span>
...
#### <span class="reviewpartition">そろそろ、買物を終わらせます。</span>
...
あとは、あまり気にしないでしょうが、計の表記が違います。再計算の下に書いてある値は「単価」、商品毎の個数を考慮した額は「小計」です。どうせヨドバシは内税表示ですから、「単価」でいいはずです。少なくとも、「合計」という一つの言葉を二つの意味で使われるのはご免です。
...
#### <span class="reviewpartition">決済します。</span>
![購入確認](confirm.jpg)
...
#### <span class="reviewpartition">やっと買い物が終わりました。</span>
![手続き終了](orderend.jpg)
...
あまりいいところが無かったです。今回は書籍ですが、他の商品カテゴリーでも同じくらい分かりにくいわけですから、モバイル版の売上はデスクトップ（フルブラウザー）版より低いのではないでしょうか。そして経営層は数字だけを見て「モバイルは稼げないから投資しない」と判断して、さらに商機を逃しているのではないでしょうか。ありがちで怖いです。

色についてはよくできていますが、二点気になりました。

##### <span style="background-color:darkgray; color:yellow;">黄色</span>
ゴールドポイントという名前からテキストをゴールド色で表示するという動機は分かります。しかし、評価の星の色が黄色なので、色だけを見ると両者が同じカテゴリーに属するように見えます。別々の文脈であればいいのですが、商品の属性として常に関連付いているので、今回のように厳しい目で見ると気になります。これが売上に影響するとは考えにくいですが。

##### <span style="color:red;">赤</span>
ヨドバシカラーでしょうか。赤をあちこちで使っています。赤は目立ちます。なぜなら、危険を意味する色だからです。カートに入れる時は十分注意しなさい、という意味なら理解できます。しかし、売ろう売ろう精神に反していることが腑に落ちません。買物は楽しくしたいものです。
